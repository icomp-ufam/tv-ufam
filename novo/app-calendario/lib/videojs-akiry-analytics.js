/**
 * videojs-akiry-analytics
 * @version 0.0.1
 * @copyright 2016 [object Object]
 * @license MIT
 */
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.videojsAkiryAnalytics = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
"use strict";
...
var constants = Object.freeze({
	publicToken: "wCsI7SVBzPPBAzGSU6HsBgVbPPjO+6BOhgC0sxY5d80=",
	baseUrl: "http://akirymedia.com:8080",
	production: true
});
...
function send(event) {
  var log = {
    timeline: {
      ...
      token: _constantsJs2['default'].publicToken,
      event: event.name,
  ...
  if (window.akiry) {
    log.timeline.videoId = window.akiry.videoId;
    log.timeline.appId = window.akiry.appId;
    log.timeline.id = window.akiry.id;
  }

  Object.assign(log, event.state);

  _jquery2['default'].ajax({
    type: 'POST',
    url: _constantsJs2['default'].baseUrl + '/api/analytics',
    beforeSend: function beforeSend(request) {
      request.setRequestHeader('Authorization', 'Bearer ' + _constantsJs2['default'].publicToken);
    },
    data: {
      type: 'player',
      object: log
    ...
    success: function success(result) {
      _loggerJs2['default'].log(result);
    },
    error: function error(_error) {
      _loggerJs2['default'].error(_error);
    }
  });
}
...
var Event = (function () {
  function Event(player) {
    ...
    this.name = '';
    this.timestamp = '';
    this.analytics = "player";
    this.state = new _stateJs2['default'](player);
  }
...
module.exports = exports['default'];
},{"./constants.js":1,"./logger.js":3,"./state.js":4,"jquery":7}],3:[function(require,module,exports){
'use strict';
...
function log(msg) {
  if (!_constantsJs2['default'].production) {
    console.log(msg);
  }
}
...
var State = (function () {
  ...
  _createClass(State, [{
    ...
    value: function update() {
      this.volume = _player.volume();
      this.playerResolution = _player.currentDimensions();
      this.supportsFullScreen = _player.supportsFullScreen();
      this.seeking = _player.seeking();
      this.remainingTime = _player.remainingTime();
      this.isPaused = _player.paused();
      this.isMuted = _player.muted();
      this.preload = _player.preload();
      this.networkState = _player.networkState();
      this.isFullscreen = _player.isFullscreen();
      this.autoplay = _player.autoplay();
      this.ended = _player.ended();
      // this.canPlayType = _player.canPlayType(_player.currentType_);
      this.duration = _player.cache_.duration;
      this.source = _player.cache_.src;
      this.currentTime = _player.cache_.currentTime;
      this.currentType = _player.currentType_;
      this.isScrubbing = _player.scrubbing_;
      this.isOnline = _is_js2['default'].online();
    }
  }]);
...
module.exports = exports['default'];
},{"is_js":6}],5:[function(require,module,exports){
"use strict";
...
exports["default"] = {
  'getVisibility': getVisibilityProperties
};
module.exports = exports["default"];
...
var _visibilityJs = require('./visibility.js');
...
var onPlayerReady = function onPlayerReady(player, options) {
  player.addClass('vjs-akiry-analytics');
};
 ...
 *
 * @function akiryAnalytics
 * @param    {Object} [options={}]
 *           An object of options left to the plugin author to define.
 */
var akiryAnalytics = function akiryAnalytics(options) {
  var _this = this;

  var event = new _eventJs2['default'](this);
  var visibility = _visibilityJs2['default'].getVisibility();
  ...
  this.on('fullscreenchange', function (evnt) {
    event.update('fullscreenchange');
  });

  this.on('volumechange', function (evnt) {
    event.update('volumechange');
  });

  this.on('play', function (evnt) {
    event.update('play');
  });

  this.on('pause', function (evnt) {
    event.update('pause');
  });

  this.on('useractive', function (evnt) {
    event.update('useractive');
  });

  this.on('userinactive', function (evnt) {
    event.update('userinactive');
  });

  this.on('ended', function (evnt) {
    event.update('ended');
  });

  this.on('error', function (evnt) {
    event.update('error');
  });

  this.on('timeupdate', function (evnt) {
    // TODO limit time?
    // event.update('timeupdate');
  });

  document.addEventListener(visibility.visibilityChange, function () {
    event.update('visibilitychange');
  });

  // Scroll and Resize Events must not send to Server
  (0, _jquery2['default'])(window).scroll(function (evnt) {
    event.update('scroll');
  });

  (0, _jquery2['default'])(window).resize(function (evnt) {
    event.update('resize');
  });
};

// Register the plugin with video.js.
_videoJs2['default'].plugin('akiryAnalytics', akiryAnalytics);

// Include the version number.
akiryAnalytics.VERSION = '1.0.0';

exports['default'] = akiryAnalytics;
module.exports = exports['default'];
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./constants.js":1,"./event.js":2,"./visibility.js":5,"jquery":7}]},{},[8])(8)
});